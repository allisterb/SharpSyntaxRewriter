#region Attribution
/* Based on StoreObjectCreation.cs
 * StoreObjectCreation.cs has the following copyright notice:
 * ----------------------------------------------------------
...
{
    public class StoreStructCreation : StatementSynthesizerRewriter
    {
        public const string ID = "<store struct creation>";
